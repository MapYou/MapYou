...
public abstract class FacebookControllerFragment extends Fragment {
	...
	public void getID() {
		if (isSession()) {
			...
			mFacebook.authorize(getActivity(), PERMS, new LoginDialogListener());
		}
	}
		...
		new AsyncTask<Void, Void, Bitmap>(){
			...
			protected void onPostExecute(Bitmap result) {
				...
				try {
					...
					UtilAndroid.makeToast(getActivity(), "Error", 5000);
				}
			};
