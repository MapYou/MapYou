 ...
 *
 */
public class MapMeTab extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent mapmeTabIntent = new Intent(this, MapMeHome.class);
		...
		Intent usersTabIntent = new Intent(this, MapMeUserHome.class);
