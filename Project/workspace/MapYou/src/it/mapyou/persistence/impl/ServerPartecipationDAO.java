 ...
 *
 */
public class ServerPartecipationDAO implements Partecipation_DAO {

	/* (non-Javadoc)
	 * @see it.mapyou.persistence.DAOSubjectModelInterface#selectByModelID(int)
	 */
	@Override
	public Partecipation selectByModelID(int modelID) {
	 ...
	 */
	@Override
	public boolean insert(Partecipation t) {
		// TODO Auto-generated method stub
		return false;
	}
	 ...
	 */
	@Override
	public boolean delete(Partecipation t) {
		// TODO Auto-generated method stub
		return false;
	}
	 ...
	 */
	@Override
	public boolean update(Partecipation t) {
		// TODO Auto-generated method stub
		return false;
	}
	 ...
	 */
	@Override
	public List<Partecipation> selectAll() {
		// TODO Auto-generated method stub
		return null;
	}
