...
/**
 * Classe per il parsing dei risultati ottenuti utilizzando le Direction API
 * 
 * @author mapyou (mapyouu@gmail.com)
 *
 */
public class ParserDataFromDirectionsApi implements ConfigurationExternalAPI{

	private Point orig, dest;
	 ...
	 * @param dest
	 */
	public ParserDataFromDirectionsApi(Point orig, Point dest) {
		super();
		this.orig = orig;
		this.dest = dest;
	}
